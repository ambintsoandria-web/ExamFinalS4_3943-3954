...
alter table
    transactions
add
    column frais_commission real default 0;

alter table
    transactions
add
    column id_operateur_recepteur integer defaul null;
...
alter table
    prefixes
add
    column id_operateur integer not null;
...
FROM
    transactions
    JOIN types_operations ON transactions.type_operation_id = types_operations.id
WHERE
...
-- 1. OPERATEURS
INSERT INTO
    operateurs (telephone, nom, mot_de_passe)
VALUES
...
-- 7. TRANSACTIONS
INSERT INTO
    transactions (client_id, type_operation_id, montant, frais)
VALUES
    (
        1,
        (
...
-- 8. TRANSFERTS
INSERT INTO
    transferts (transaction_id, client_destinataire_id)
VALUES
    (3, 2);

-- 9. HISTORIQUE SOLDE
INSERT INTO
    client_solde_historique (client_id, solde_precedent)
VALUES
    (1, 0),
    (1, 100000),
    (1, 80000),
